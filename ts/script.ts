const c1: Conta = new Conta('1', 100);
const c2: Conta = new Conta('2');
...
const contaBonificada: ContaBonificada = new ContaBonificada('10', 100);
contaBonificada.creditar(10);
console.log(contaBonificada.saldo);

const p: Pessoa = new Pessoa("João", 18, new Date("18 december, 2005"));
const pf: PessoaFisica = new PessoaFisica("Gabriel", 29, new Date("12 december, 1993"), "123.456.789-00");
const pj: PessoaJuridica = new PessoaJuridica("Eduarda", 30, new Date("13 december, 1992"), "98.765.432/1000-30");
